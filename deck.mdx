...
```diff 2 title="Instantiate the generator" subtitle="Generator {  }"
```
...
```diff 4 title="return completes generator" subtitle="{value: 'OK!!!', done: true}"
```
...
```diff 4 title="console.log(1)" subtitle="{value: undefined, done: false}"
```
...
```diff 5 title="console.log(2)" subtitle="{value: undefined, done: false}"
```
...
- [ECMAScript Compatibility Table](https://kangax.github.io/compat-table/es6/#test-generators)
- [caniuse - generator functions](https://caniuse.com/#feat=es6-generators)
